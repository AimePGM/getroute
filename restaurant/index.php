        ...
        <div class="container">
           ...
           <div class="container">
            <div style="margin-left: 50px; margin-top: 20px;">
              <font color="#F26328" style="font-size: 50px; text-shadow: 4px 4px 10px #888888;">
            <span class="glyphicon glyphicon-cutlery"></span></font>  
            <font color="#1C1C1C" style="font-size: 50px; text-shadow: 4px 4px 10px #888888;"> Restaurant's Name</font>
           ...
           <div class="container span2 account-photo-container hidden-phone" style="margin-top: 30px;margin-left: 5%;">
           ...
           <div class="container span3 hidden-desktop" style="margin-left: 20%; margin-top: 10px;">
            <table style="text-align: center;">
             ...
             <!--Menu phone tablet-->
                 ...
                 <div class="container span12 hidden-desktop" style="width: 95%; margin-bottom: 15px; margin-left: 5%;">

                
                    
                         <button type="button" class="btn btn-success" style="width: 95%;">Menu</button>
            ...
            <div class="container" style="margin-top: 50px;">
              ...
              <div class="container ads-container span3 visible-desktop">
                  ...
                  <div class="container span3" style="
                    margin: auto;
                    margin-left: 10px;
                    margin-bottom: 15px;
                    ">
                    <button type="button" class="btn btn-success" style="width: 95%;">Menu</button></div>
                    <div class="container span3" style="
                    margin: auto;
                    ">
