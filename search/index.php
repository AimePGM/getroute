...
<html lang="en">
  ...
  <body onload="initialize()" style="background-color: #F7BE81;">
      ...
      <!--navber-inner navbar-fixedtop visible-tablet -->
       <div class="navbar navbar-default navbar-fixed-top visible-desktop" style="text-align: center;">
        ...
        <div class="container">
           ...
           <div class="container">
            <!--info box-->
            <div class="container search-route-info-box">

              <!--info-->
              <div class="container search-route-info">

              <font color="#1C1C1C" style="font-size: 10px;">
                   <span class="glyphicon glyphicon glyphicon-road"></span></font>  

                  <font color="#FF8000" style="font-size: 20px;"> Get Your Route! </font>
                  <!--search info-->

                  <div class="container" style="width: 90%;">

                    <!--ตรงนี้คือ ถ้าเค้าไม่ได้ใส่มาใน input ก็ไม่ต้องโชว์นะ 
                    โชว์แค่อันที่เค้าใส่มาใน input พอนะจ้ะ ซารางเฮโยยยยย-->
                    <table>
                      <tr>
                        <td style="width: 60%;">
                  ...
                  <td>
                     ...
                     <div class="container search-route-info-type">
              ...
              <!--map-->
              <div class="container search-route-map span7">
              </div>
              <!--map-->
          ...
          <!--body-->
          <div class="container search-body-box">
            <div class="container span8 search-area-box hidden-phone">
             <div class="section group">
        <div class="col span_1_of_3 search-ele">
      ...
      <div class="container span8 search-area-box visible-phone">
             <div class="section group">
       
              <div class="row search-phone-row">
        <div class="col span_1_of_2 search-ele">
        ...
        <div class="col span_1_of_2 search-ele">
             ...
             <div class="container span3 search-ads-box search-list hidden-phone">
             <div class="col search-ele">
